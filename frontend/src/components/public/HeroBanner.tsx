...
export default function HeroBanner() {
  ...
  return (
    <section
      ...
      className="relative h-[420px] sm:h-[520px] lg:h-[600px] overflow-hidden bg-gray-900"
    >
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 flex flex-col items-start justify-center">
        ...
        >
          ...
          <p className="mt-3 sm:mt-4 text-white/90 max-w-md text-sm sm:text-base lg:text-lg">
          ...
          <button
            ...
            className="mt-6 sm:mt-8 inline-flex items-center justify-center px-6 sm:px-8 py-2.5 sm:py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl transition-colors duration-200 text-sm sm:text-base"
          >
            Explore Cars
          </button>
        </motion.div>
