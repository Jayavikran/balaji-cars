        ...
        <div className="space-y-5">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-card shadow-card p-6">
              <h3 className="font-display font-semibold text-ink mb-5">Revenue by Brand</h3>
            ...
            <div className="bg-white rounded-card shadow-card p-6">
              <h3 className="font-display font-semibold text-ink mb-5">Inventory by Status</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            {/* Fuel Distribution */}
            <div className="bg-white rounded-card shadow-card p-6">
              <h3 className="font-display font-semibold text-ink mb-5">Fuel Type Distribution</h3>
            ...
            {/* Top Selling Models */}
            <div className="bg-white rounded-card shadow-card p-6">
              <h3 className="font-display font-semibold text-ink mb-5">Top Selling Models</h3>
          ...
          <div className="bg-white rounded-card shadow-card p-6">
            <h3 className="font-display font-semibold text-ink mb-5">Revenue by Sales Executive</h3>
